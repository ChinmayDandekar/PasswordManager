...
SECRET_KEY = 's*fy7mt!z+vyx9^#6^r$un*61u&8pbq)v-zogts@5&h*c#xr72'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["192.168.0.101",'imagine-pass-manager.herokuapp.com','127.0.0.1']
# ALLOWED_HOSTS = ['imagine-pass-manager.herokuapp.com']
...
DATABASES = {
    'default': {
        ...
        'USER': 'emnlazweftzbdu',
        'PORT': 5432,
        'PASSWORD': '6343a090e9270ab0806eda4da6356baceeecfe00962dbb7b12ff9a6f777ea20b',
